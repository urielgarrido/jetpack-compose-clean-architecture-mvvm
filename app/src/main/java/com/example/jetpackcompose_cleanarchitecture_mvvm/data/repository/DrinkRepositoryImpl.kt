...
import com.example.jetpackcompose_cleanarchitecture_mvvm.domain.exceptions.FetchDrinkException
...
class DrinkRepositoryImpl @Inject constructor(
    ...
    private suspend fun fetchFromApi(): Drink {
    ...
    override suspend fun saveDrinkLocally(drink: Drink) {
